 ...
 * like "coffee 6.75 at Blue Bottle" or "groceries 42 for Roommates"; anything it can't extract
 * an amount from returns null and the caller falls back to Quick Capture's keypad entry.
 */
